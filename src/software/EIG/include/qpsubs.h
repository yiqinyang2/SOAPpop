...
void setwt(SNP **snpmarkers, int numsnps, Indiv **indivmarkers, int nrows, 
  int *xindex, int *xtypes, char * outpop, char **eglist, int numeg, char *deletesnpoutname) ;
...
void addblocktomatrix(double *X, const int target_col, const int target_row, const int x_cols, const double *block,
  const int block_cols, const int block_rows);

void addouterblock(double *X, const double *v, const int nelts, const int v_start, const int v_stop,
  const int vt_start, const int vt_stop);
