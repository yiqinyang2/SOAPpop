...
close(PARFILE);
$command = "/panfs/ANIMAL/GROUP/group001/fengxikang/EIG/bin/smartpca";          # MUST put bin directory in path
$command .= " -p $parfile >$l";
print("$command\n");
system("$command");
...
### cax ploteig
$command = "perl /panfs/ANIMAL/GROUP/group001/fengxikang/EIG/bin/ploteig";           # MUST put bin directory in path
$command .= " -i $evec";
$command .= " -c 1:2 ";
$command .= " -p $popstring ";
$command .= " -x ";
...
if ( $i =~ m/\.ped$/ || $i =~ m/\.PED/ )  {
  $command = "perl /panfs/ANIMAL/GROUP/group001/fengxikang/EIG/bin/evec2pca-ped.perl $k $evec $b $o";
}
else  {
  $command = "perl  /panfs/ANIMAL/GROUP/group001/fengxikang/EIG/bin/evec2pca.perl $k $evec $b $o";
}
print("$command\n");
system("$command");
